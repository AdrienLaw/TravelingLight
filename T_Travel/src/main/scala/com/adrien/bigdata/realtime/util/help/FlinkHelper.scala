...
import com.adrien.bigdata.realtime.streaming.rdo.QRealTimeDimDO.ProductDimDO
import com.adrien.bigdata.realtime.streaming.rdo.QRealtimeDO.OrderDetailData
import com.adrien.bigdata.realtime.util.PropertyUtil
import com.adrien.bigdata.realtime.util.es.ESConfigUtil
import com.adrien.bigdata.realtime.util.es.ESConfigUtil.ESConfigHttpHost
